...
local settings = {
    folder_name = "aphixeOden"; -- stupid shit
...
local themes = {
    ["Default"] = {
        ...
        ["Risky Text"] = Color3.fromRGB(255, 1, 1),
        ["Object Background"] = Color3.fromRGB(41,41,50)
    };
}

local themeobjects = {}
local library = {theme = table.clone(themes.Default),currentcolor = nil, folder = "aphixeOden", flags = {}, open = true, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}, notifications = {}};
